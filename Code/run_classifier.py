...
from models import MsdBERT, BertOnly, ResNetOnly, Res_BERT,Res_BERT_Pair,Res_BERT_Pair_2
...
def main():
    ...
    if args.model_select == 'BertOnly':
        ...
        model = MsdBERT()
    elif args.model_select == 'Res_BERT_Pair':
        model = Res_BERT_Pair()
    elif args.model_select == 'Res_BERT_Pair_2':
        model = Res_BERT_Pair_2()
    else:
