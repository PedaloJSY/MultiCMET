...
class MsdBERT(nn.Module):
    def __init__(self):
        ...
        self.hashtag_bert = BertModel.from_pretrained('bert-base-chinese')
        self.tanh = nn.Tanh()
...
class Res_BERT_Pair(nn.Module):
    ...
    def forward(self, input_ids, visual_embeds_att, input_mask, added_attention_mask, hashtag_input_ids,
        ...
        self.pair_tensor = self.pair_tensor.to(sequence_output.dtype)
